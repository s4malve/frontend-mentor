...
export default () => {
  return (
    <header className="grid min-h-screen relative w-full place-content-center">
      <h1 className="font-code mobile-xs:text-3xl mobile-l:text-4xl tablet-md:text-6xl desktop-lg:text-7xl grid grid-cols-[auto_1fr] grid-rows-[repeat(4,auto)] gap-y-4 gap-x-4 md:mb-20">
        ...
        <span className="items-center max-w-[200px] mr-8 row-end-4 row-start-3 text-base leading-6 hidden md:flex">
          Press to start seeing my versions
        </span>
        <a
          href="/#projects"
          className="col-start-1 font-bold hidden py-3 rounded-md row-start-4 self-center text-base text-center w-full h-fit bg-pale-red text-slate-200 hover:bg-pale-red/90 active:bg-pale-red/80 md:inline-block"
        >
          Start
        </a>
        <span className="block md:col-end-3 md:col-start-2">
